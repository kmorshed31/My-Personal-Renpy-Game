...
init python:
    # Show the HUD on top of in-game screens
...
screen hud():
    ...
    if not main_menu:
        zorder 100
        textbutton "Stats":
            style "quick_button"          # optional; use your GUI style
            xpos 12
            ypos 12
            action ShowMenu("stats")      # open the stats page
...
screen stats():
    ...
    frame:
        ...
        text "Willpower: [willpower]"
        textbutton "Close" xalign 1.0 action Return()
